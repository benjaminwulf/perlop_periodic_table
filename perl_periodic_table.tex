...
%% Fill Color Styles
  ...
  \tikzstyle{NumericFill} = [fill=blue!55]
...
%% Element Styles
  ...
  \tikzstyle{Numeric} = [Element, NumericFill]
...
%% Mathmatical 
  \node[name=MethodCall, Element] {\NaturalElementTextFormat{binary, left}{9}{-\textgreater}{Method Call}};
  \node[name=Inc, below of=MethodCall, Element] {\NaturalElementTextFormat{unary, nonassoc}{8}{++}{Increment}};
  \node[name=Dec, right of=Inc, Element] {\NaturalElementTextFormat{unary, nonassoc}{8}{--}{Decrement}};
  \node[name=Exponentiation, below of = Inc, Element] {\NaturalElementTextFormat{binary, right}{7}{**}{Exponentiation}};
  \node[name=SignPlus, below of = Exponentiation, Element] {\NaturalElementTextFormat{unary, right}{6}{+}{Sign}};
  \node[name=SignMinus, right of = SignPlus, Element] {\NaturalElementTextFormat{unary, right}{6}{-}{Sign}};

    
%%   \node[name=Na, below of=Inc, AlkaliMetal] {\NaturalElementTextFormat{11}{22.990}{Na}{Sodium}};
...
%% %% Group 2 - IIA
%%   \node[name=Be, right of=Inc, AlkalineEarthMetal] {\NaturalElementTextFormat{4}{9.0122}{Be}{Beryllium}};
...
%% %% Period
%%   \node[name=Period1, left of=MethodCall, PeriodLabel] {1};
%%   \node[name=Period2, left of=Inc, PeriodLabel] {2};
...
%% %% Group
%%   \node[name=Group1, above of=MethodCall, GroupLabel] {1 \hfill IA};
...
%% Diagram Title
  %% \node at (MethodCall.west -| Fe.north) [name=diagramTitle, TitleLabel]
